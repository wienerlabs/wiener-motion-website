        ...
        <>
            <div className="modal-overlay fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center p-4">
                <div className="modal-content bg-white w-full max-w-7xl max-h-[90vh] overflow-y-auto rounded-lg relative">
                    <button onClick={handleClose} className="sticky top-4 right-4 float-right z-10 w-12 h-12 bg-black text-[#fef3dc] rounded-full flex items-center justify-center hover:bg-[#fef3dc] hover:text-black transition-colors duration-300 font-bold text-2xl">×</button>
