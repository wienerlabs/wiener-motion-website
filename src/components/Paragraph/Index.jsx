  ...
  return (
    <div data-color="white" className="para section w-full flex items-center justify-center px-8  ">
        <div className="text sm:w-[80%] flex flex-col items-center sm:items-start justify-between ">
            ...
            <h3 className='textpara sm:w-[50%] text-[#3d3a2f] font-[Sansita] tracking-wide text-[2.4vh] sm:text-[3.5vh] font-medium text-center leading-[5vh] mb-10'>Working with the Wiener Labs team has transformed our real estate portfolio management. Their RWA tokenization platform enabled us to fractionalize our properties, unlocking unprecedented liquidity and global investor access. The smart contract automation reduced our operational costs by 60% while providing 24/7 trading capabilities. Their expertise in blockchain infrastructure and DeFi protocols is unmatched in the industry.</h3>
            <div className="pers w-[50%] flex flex-col items-center justify-center gap-2 ">
                ...
                <h1 className=' text-[2.8vh] sm:text-[3.8vh] font-medium'>Sarah Mitchell</h1>
                <h3 className='text-zinc-500 text-[2.4vh] whitespace-nowrap'>Portfolio Director @ GlobalAssets Inc.</h3>
            </div>
        </div>  
    </div>
  )
